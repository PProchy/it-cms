<?php
// source: C:\xampp\htdocs\projects\it-network\app/config/config.neon 
// source: C:\xampp\htdocs\projects\it-network\app/config/config.local.neon 

class Container_fc4b634613 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\projects\it-network\app',
			'wwwDir' => 'C:\xampp\htdocs\projects\it-network\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\projects\it-network\app/../temp',
		];
	}
	...
	{
		$service = new App\Presenters\BasePresenter($this->getService('5'));
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\projects\it-network\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\projects\it-network\app/../temp/cache');
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_fc4b634613 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\projects\it-network\app/../temp/cache/latte');
	...
	public function createService5(): App\Model\DatabaseManager
	{
		$service = new App\Model\DatabaseManager;
		return $service;
	}
